        ...
        <div className="divide-y divide-border">
          <AnimatePresence>
            {filtered.length === 0 ? (
                ...
                >
                    {/* Mobile & Desktop: Description Icon */}
                    ...
                    {/* Hover visual hint for editing */}
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-5 bg-white pointer-events-none md:hidden"></div>
                </motion.div>
                ))
            )}
          </AnimatePresence>
