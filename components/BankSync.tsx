...
import { Landmark, Plus, Trash2, AlertCircle, Upload, Wallet, CreditCard, Building2, Edit2, RefreshCw, Link2, Wifi, Globe } from 'lucide-react';
...
const BankSync = () => {
  ...
  const handleFormSubmit = (data: Omit<BankAccount, 'id' | 'lastSync' | 'connected'>) => {
    if (editingAccount) {
