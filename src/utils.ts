...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  // Goals Missing Keys
  'new_goal': { pt: 'Nova Meta', en: 'New Goal' },
  'goal_name': { pt: 'Nome da Meta', en: 'Goal Name' },
  'target_amount': { pt: 'Valor Alvo', en: 'Target Amount' },
  'initial_amount': { pt: 'Valor Inicial', en: 'Initial Amount' },
  'create_goal': { pt: 'Criar Meta', en: 'Create Goal' },
  'add_funds_title': { pt: 'Adicionar Fundos', en: 'Add Funds' },
  'add_funds_desc': { pt: 'Registar um depósito para esta meta.', en: 'Record a deposit for this goal.' },
  'amount_to_add': { pt: 'Valor a Adicionar', en: 'Amount to Add' },
  'confirm_deposit': { pt: 'Confirmar Depósito', en: 'Confirm Deposit' },
  'remove_goal_title': { pt: 'Remover Meta', en: 'Remove Goal' },
  'remove_goal_msg': { pt: 'Tem a certeza que deseja apagar esta meta? O histórico de poupança será mantido nas transações.', en: 'Are you sure you want to delete this goal? Savings history will be kept in transactions.' },
  'goal_limit_reached': { pt: 'Limite de Metas', en: 'Goal Limit Reached' },
  'of': { pt: 'de', en: 'of' },
  'upgrade': { pt: 'Melhorar Plano', en: 'Upgrade Plan' },
  'target_val': { pt: 'Alvo', en: 'Target' },
  'progress': { pt: 'Progresso', en: 'Progress' },
  'current': { pt: 'Atual', en: 'Current' },
  'add_savings': { pt: 'Depositar', en: 'Deposit' },
  'no_goals': { pt: 'Sem metas definidas.', en: 'No goals defined.' },
